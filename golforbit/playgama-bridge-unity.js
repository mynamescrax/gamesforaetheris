        ...
        .then(() => {
            ...
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/d2da0a97916b5a9f8eab44498a122e3f.data.unityweb',
                        frameworkUrl: 'Build/ca1099a7772e4f085b9fc6b7c0389f59.framework.js.unityweb',
                        codeUrl: 'Build/b6fe6e288fefbe64909957135ac312a1.wasm.unityweb',
...
// advertisement (spoofed — no real ads, instant rewards)
...
window.showBanner = function(position, placement) {
    sendMessageToUnity('OnBannerStateChanged', 'hidden')
}
...
window.showInterstitial = function(placement) {
    ...
    setTimeout(() => sendMessageToUnity('OnInterstitialStateChanged', 'closed'), 50)
}

window.showRewarded = function(placement) {
    sendMessageToUnity('OnRewardedStateChanged', 'opened')
    setTimeout(() => sendMessageToUnity('OnRewardedStateChanged', 'rewarded'), 50)
    setTimeout(() => sendMessageToUnity('OnRewardedStateChanged', 'closed'), 100)
}
