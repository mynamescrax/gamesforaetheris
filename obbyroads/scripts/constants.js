...
const AdProviderPoki = "Poki";

var displayAdProvider = AdProviderPoki;
var videoAdProvider = AdProviderPoki;
...
function isPokiEnabled()
{
  return displayAdProvider === AdProviderPoki || videoAdProvider === AdProviderPoki;
}
