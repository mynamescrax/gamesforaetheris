...
var stageCompleteBannerShownTimestamp = {val: -1}; //wrap in object to pass by ref
const divIdStageCompleteLeftBanner = "adContainerStageCompleteLeft";
const divIdStageCompleteRightBanner = "adContainerStageCompleteRight";

var raceStartBannerShownTimestamp = {val: -1}; //wrap in object to pass by ref
const divIdRaceStartLeftBanner = "adContainerRaceStartLeft";
const divIdRaceStartRightBanner = "adContainerRaceStartRight";
...
function hideStageCompleteBanner()
{
  if(!offCanvasAdsEnabled)
  {
    hideAdContainer(divIdStageCompleteLeftBanner);
    hideAdContainer(divIdStageCompleteRightBanner);
    hideStageCompleteAd();
  }
}

function showStageCompleteBanner()
{
  if(!offCanvasAdsEnabled)
  {
    hideLongBanner();
    ...
    showAdContainer(divIdStageCompleteLeftBanner);
    showAdContainer(divIdStageCompleteRightBanner);
    requestStageCompleteAd();
  }
}

function hideRaceStartBanner()
{
  if(!offCanvasAdsEnabled)
  {
    hideAdContainer(divIdRaceStartLeftBanner);
    hideAdContainer(divIdRaceStartRightBanner);
    hideRaceStartAd();
  }
}

function showRaceStartBanner()
{
  if(!offCanvasAdsEnabled)
  {
    hideLongBanner();
    hideMainMenuBanner();
    hideStageCompleteBanner();

    showAdContainer(divIdRaceStartLeftBanner);
    showAdContainer(divIdRaceStartRightBanner);
    requestRaceStartAd();
  }
}
