...
function isFullscreen()
{
  ...
  function openPrivacyUrl()
  {
    onNextMouseUp(function () {
      ...
      {
        window.open("https://obbyroads.io/privacy/privacyPW.html", "_blank");
      }
      else if(isAdinPlayEnabled())
      {
        window.open("https://obbyroads.io/privacy/privacyAdinplay.html", "_blank");
      }
      else
      {
        window.open("https://obbyroads.io/privacy/privacy.html", "_blank");
      }
    });
  }
