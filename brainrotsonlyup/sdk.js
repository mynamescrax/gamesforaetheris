...
(() => {
    ...
    if (window === window.top || window.sdkLoaderWasInited) {
        ...
        window.isSdkLoader = !0, window.YaGames = {
            init: o => {
                var d;
                return s ? null == (d = window.YaGames) ? void 0 : d.init(o) : i ? Promise.reject(v) : t ? (console.warn("YaGames was initialized"), t) : (t = new Promise((t, s) => {
                    e = t, r = s, n = o, a = !0
                }), t)
            }
        };
        ...
        y ? h(y) : (o = function*() {
            ...
            var n = e => {
                ...
                a = r => r.done ? e(r.value) : Promise.resolve(r.value).then(n, t);
            a((o = o.apply(null, null)).next())
        })).then(e => {
            const r = new URL(e),
                o = r.searchParams,
                n = o.get("sdk"),
