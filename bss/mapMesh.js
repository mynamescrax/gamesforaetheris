...
box(-59,4,20,2,0.3,3,[0,160,0],[0.4,0.32,0.2],false,true);
...
box(0+x,3.45+y,0.15+z-0.25,0.1,2.6,0.1,[5,0,0],[0.4,0.2,0.1],false,false)

box(0.35+x,1.8+y,0.35+z-0.25,0.1,1.3,0.1,[-30,0,40],[0.4,0.2,0.1],false,false)
box(0.7+x,0.65+y,0.7+z-0.25,0.1,1.4,0.1,false,[0.4,0.2,0.1],false,false)
box(-0.35+x,1.8+y,0.35+z-0.25,0.1,1.3,0.1,[-30,0,-40],[0.4,0.2,0.1],false,false)
box(-0.7+x,0.65+y,0.7+z-0.25,0.1,1.4,0.1,false,[0.4,0.2,0.1],false,false)

box(-0.38+x,3.25+y,0.33+z-0.25,0.1,0.9,0.1,[-20,0,-70],[0.4,0.2,0.1],false,false)
box(-0.82+x,2.75+y,0.55+z-0.25,0.1,0.7,0.1,[-15,0,-10],[0.4,0.2,0.1],false,false)
box(0.38+x,3.25+y,0.33+z-0.25,0.1,0.9,0.1,[-20,0,70],[0.4,0.2,0.1],false,false)
box(0.82+x,2.75+y,0.55+z-0.25,0.1,0.7,0.1,[-15,0,10],[0.4,0.2,0.1],false,false)

box(-0.6+x,3.8+y,0.53+z-0.25,0.1,1.6,0.1,[-25,0,-60],[0.4,0.2,0.1],false,false)
box(-1.3+x,2.8+y,0.94+z-0.25,0.1,1.3,0.1,[-7,0,-5],[0.4,0.2,0.1],false,false)
box(0.6+x,3.8+y,0.53+z-0.25,0.1,1.6,0.1,[-25,0,60],[0.4,0.2,0.1],false,false)
box(1.3+x,2.8+y,0.94+z-0.25,0.1,1.3,0.1,[-7,0,5],[0.4,0.2,0.1],false,false)

cylinder(0+x,4.7+y,0.25+z-0.25,0.05,0.4,4,0.4,0.2,0.1,1,95,0,0,0.12)
sphere(0.07+x,4.9+y,0.35+z-0.25,0.06,0,1,0.5,0,1)
sphere(-0.07+x,4.9+y,0.35+z-0.25,0.06,0,1,0.5,0,1)

box(-0.49+x,5.25+y,0.8+z-0.25,0.01,1.6,0.01,[45,0,50],[0.4,0.2,0.1],false,false)
box(0.49+x,5.25+y,0.8+z-0.25,0.01,1.6,0.01,[45,0,-50],[0.4,0.2,0.1],false,false)
}


sphere(-48,26,90,4,1,1,1,1,1);
sphere(-50,25.5,90,3,1,1,1,1,1);
sphere(-45.5,25.5,89,3,1,1,1,1,1);
sphere(-49,28,90,2,1,0.4,0.4,0.4,1);
cylinder(-48,24.45,86,3.5,0.4,9,1,0.4,1.3,1,90,0,0)
cylinder(-48,24.5,86,3.3,0.4,9,1,1,1,1,90,0,0)
sphere(-49-1.25,28+1.25,90,2*0.5,1,1,0.4,1,0.4);
sphere(-49-2.3,28+2.3,90,2*0.25,1,1,0.4,1,0.4);


sphere(-79,5,19.5,4,1,1,1,1,1);
sphere(-79,5,22,4,1,1,1,1,1);
sphere(-77,5,18,3,1,1,1,1,1);
cylinder(-75,3.95,20.75,3.5,0.4,9,0.2,1,1.1,1,90,0,0)
cylinder(-75,4,20.75,3.3,0.4,9,1,1,1,1,90,0,0)
...
box(13.5,-0.3,37-1.5+(window.isBeesmas?6:0),0.4,4,15,false,[1.05,1.05,1.05,0.5],true,false,false);
...
if(window.isBeesmas){
box(-63,29,91,5,1,6,false,[0.7,0.7,0.7,0.4],true,false);

if(INFO.beesmasMachine_gummyBear){
cylinder(-23.5-0.1,13.7,5-0.1,0.4,0.7,9,1.4,0.4,1.4,0.7,-45,45,0);
}
